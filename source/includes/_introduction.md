...
In order to support TLSNotaryProof (retrieving content from an HTTPS web page) one needs to use [https://api-dot-vizlorepaymentprocessor.appspot.com]() instead of [https://api.chainrider.io]() domain in requests. Bold info might be stressed within documentation of ChainRider.
